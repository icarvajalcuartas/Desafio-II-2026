...
void leerHistoricoEquipo(Equipo &equipo, const string &lineaCSV)
{
    ...
    h.setTarjetasAmarillas((unsigned short int)stoi(columnas[10]));
    h.setTarjetasRojas((unsigned short int)stoi(columnas[11]));
    h.setFaltas((unsigned short int)stoi(columnas[12]));
