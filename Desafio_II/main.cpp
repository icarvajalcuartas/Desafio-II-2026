...
int main()
{
    ...
    Equipo e10;
    cargarEquipoDesdeArchivo(e10, "selecciones_clasificadas_mundial.csv", "Spain");
    actualizarHistoricoEquipoArchivo(e10,"Historico_equipos.csv");
    e10.print();
    for(int n=0;n<10;n++){
        e10.setHistoricoJugador(n,n+1,n*2,n+2,n*2,n+3);
        e10.printJugador(n);
    ...
    Equipo e12;
    cargarEquipoDesdeArchivo(e12,"selecciones_clasificadas_mundial.csv","Colombia");
    e12.print();
    actualizarHistoricoEquipoArchivo(e12,"Historico_equipos.csv");
    Equipo e13;
    cargarEquipoDesdeArchivo(e13,"selecciones_clasificadas_mundial.csv","Cabo Verde");
    e13.print();
    e13.actualizarHistoricoEquipo(1,2,4,5,6);
    actualizarHistoricoEquipoArchivo(e13, "Historico_equipos.csv");
    e13.print();
    return 0;
